...
st.title("Paint your strategy")
st.sidebar.success("Select a page above.")

if "my_input" not in st.session_state:
    st.session_state["my_input"] = ""

my_input = st.text_input("Input what you want to see. For example, what were AAPL's revenue between FY2019 - FY2021?", st.session_state["my_input"])
...
#response = requests.get(f"https://data.sec.gov/api/xbrl/companyfacts/{option}.json")
